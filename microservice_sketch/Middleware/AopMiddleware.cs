...
namespace microservice_sketch.Middleware
{
    public class AopMiddleware
    {
        ...
        public async Task InvokeAsync(HttpContext context, IEnumerable<IApiService> apiServices)
        {
            api_settings _api_settings = Startup.api_settings;
            bool aop_switch = (_api_settings.memory_type.ToLower() == "memory" || _api_settings.memory_type.ToLower() == "redis") ? true : false;
            ...
            switch (context.Request.Path.Value) {
                ...
                case "/user_info":
                    ...
                    if (aop_switch)
                    {
                        ...
                        //can't return controller like response end 
